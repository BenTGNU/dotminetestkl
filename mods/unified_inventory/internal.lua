...
function unified_inventory.get_formspec(player, page)
	...
	local no_matches = F("No matching items")
	if draw_lite_mode then
		no_matches = F("No matches.")
	end

	-- Items list
	if #unified_inventory.filtered_items_list[player_name] == 0 then
		formspec[n] = "label[8.2,"..ui_peruser.form_header_y..";" .. no_matches .. "]"
	else
		...
		formspec[n] = "label[8.2,"..ui_peruser.form_header_y..";"..F("Page: @1 of @2",page,pagemax).."]"
	end
	n= n+1
